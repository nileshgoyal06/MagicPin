#!/usr/bin/env python3
"""
magicpin AI Challenge — LLM-Powered Evaluation Harness
=======================================================

A strict but fair evaluator that scores your bot and explains WHY.
...
def main():
    print_header("magicpin AI Challenge — Evaluation Harness")
    ...
    # Run the harness
    harness = EvaluationHarness(llm)
    success = harness.run(TEST_SCENARIO)
